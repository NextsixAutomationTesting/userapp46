...
xcoord = Mobile.getAttribute(findTestObject('mobile/Shortcut/android.widget.TextView - Zero Deposit'), 'x', 0)

ycoord = Mobile.getAttribute(findTestObject('mobile/Shortcut/android.widget.TextView - Zero Deposit'), 'y', 0)
